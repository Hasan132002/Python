...
def get_text_pc(i, j, gb, l1, l2):
	...
	if winner(board, "X"):
		gb.destroy()
		x = False
		box = messagebox.showinfo("Winner", "Wah yar tu to heet gaya")
	elif winner(board, "O"):
		gb.destroy()
		x = False
		box = messagebox.showinfo("Winner", "Machine se har gaya thoo!")
	elif(isfull()):
		gb.destroy()
		x = False
		box = messagebox.showinfo("barabar hogya ", "bara baar hogya")
	if(x):
		if sign % 2 != 0:
			move = pc()
